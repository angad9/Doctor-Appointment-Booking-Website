        ...
        <div>
          <div className="lg:w-[570px]">
            ...
            <p className="text__para">
              ...
              Sit, necessitatibus. Minima officia vero dolor harum nam 
              quibusdam eaque omnis animi libero magni hic praesentium, 
              mollitia ad dicta?
            </p>
      ...
      <div className="py-[30px] px-5">
        ...
        <div className="mt-[30px]">
          ...
          <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center ">
            Wolrd-class care for everyone. Our health System offers 
      ...
      <div className="container">
        ...
        <div className="xl:w-[670px]">
           <h2 className="heading">
            ...
            <ul className="pl-4">
              ...
              <li className="text__para">
                2. Seach foe your physician here, and contact their office.
              </li>
              <li className="text__para">
                3. View our physician who are accepting new patients, use the
                online sceduling tool to select an appoinment time.
              </li>
            </ul>
            <Link to='/'>
        ...
        <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
          ...
          <div className="flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]"  >
            ...
            text-headingColor  ">Wayne Colling</h4>
          </div>  
