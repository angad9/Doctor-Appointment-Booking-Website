        ...
        <div className="flex  justify-between gap-[50px] lg:gap-[130px] xl:gap-0 flex-col lg:flex-row">
            ...
            <div className="w-full lg:w-1/2 xl:w-[670px] order-1 lg:order-2">
                ...
                <p className="text__para ">For 30 years in a row, U.S, News & World Report has recognized us 
                    ...
                    Exemplifying excellence in healthcare, our commitment to patients 
                    stands unwavering.
                </p>
                <p className="text__para mt-[30px] "> Our best is something we strive for each day. caring for our 
                   ...
                   we can do tomorrw. Providing the best.Dedication fuels progress, ensuring tomorrow's 
                   care exceeds today's achievements. 
                </p>
